...
//// INPUTS
const u8   DHTPIN = 12; // DHT sensor input pin
const u8   B1_MAN = 14; // Button-1 input pin
const u8  B2_ALTA = 15; // Button-2 input pin
const u8 B3_SOBRE = 13; // Button-3 input pin

//// OUTPUTS
const u8 LED_MANUAL = 4; // LED: Refri Manual output
const u8 LED_AUTO   = 2; // LED: Refri Auto output
